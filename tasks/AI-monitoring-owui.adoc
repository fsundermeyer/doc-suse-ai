...
. Append the following environment variables to your `extraEnvVars` section in the [path]`owui_custom_overrides.yaml` file mentioned in <<ai-monitoring-owui-pipelines-cmdline>>.
+
[source,yaml]
----
extraEnvVars:
