...
The {ranchera} UI will expose features available to xref:rancher-register-features-all[], along with the following options for editing and upgrading the cluster:
