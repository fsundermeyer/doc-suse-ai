...
[[_ai_monitoring_milvus_scraping_metrics]]
...
//           <literal>milvus.<replaceable>SUSE_AI_NAMESPACE</replaceable>.svc.cluster.local:9091</literal> is a
