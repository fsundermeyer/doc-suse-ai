...
* Specifying external data sources to the AI model knowledge base is described in link:{dsc}/suse-ai/1.0/html/openwebui-using/index.html#openwebui-chat-input-field-usage. 
